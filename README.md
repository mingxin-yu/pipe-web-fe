...
2. **Automatic Deployment**:
   ...
   - You can also manually trigger a deployment by going to **Actions** → **Deploy to GitHub Pages** → **Run workflow**

3. **Access Your Site**:
   - Your site will be available at: `https://<username>.github.io/<repository-name>/`
   - For example: `https://yourusername.github.io/pipe-web-fe/`

### Local Development

The base path is automatically configured:
- **Local development**: Uses root path `/`
- **GitHub Pages**: Uses `/repository-name/` path automatically
